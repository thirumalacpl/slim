...
$state = $r1['state'];
 ...
 $lverification_inpro="(select vm.Current_Address2,vm.Ref_no,ia.sstatus,ia.subco_status,vm.First_Name,vm.Last_Name,tn.task_name as taskname,ia.name, ct.city_name, ia.verification_for, ia.qualification_name,ia.assigned_on, ia.status,ia.verification_user_id,ia.type as qualification_id, ia.location,ia.coordinator_id,ia.accept_on from insert_assigned_users as ia inner join cities as ct on ia.location=ct.city_id inner join user as us on us.User_Id=ia.assigned_to Inner join address_type at on ia.type=at.id inner join taskname tn on tn.task_name_id=at.task_name_id inner join verification_master vm on vm.Verification_Master_Id =ia.verification_user_id where ia.sstatus = 'Inprogress' and ia.state='$state' and ia.assigned_to='$user_id') union (select vm.Current_Address2,vm.Ref_no,ia.sstatus,ia.subco_status,vm.First_Name,vm.Last_Name,tk.task_name as taskname,ia.name, ct.city_name, ia.verification_for, ia.qualification_name,ia.assigned_on, ia.status,ia.verification_user_id,ia.type as qualification_id, ia.location,ia.coordinator_id,ia.accept_on from insert_assigned_users as ia inner join cities as ct on ia.location=ct.city_id inner join user as us on us.User_Id=ia.assigned_to Inner join qualifications qu on ia.type=qu.qualification_id inner join taskname tk on tk.task_name_id=qu.task_name_id inner join verification_master vm on vm.Verification_Master_Id =ia.verification_user_id where ia.sstatus = 'Inprogress' and ia.state='$state' and ia.assigned_to='$user_id') union (select vm.Current_Address2,vm.Ref_no,ia.sstatus,ia.subco_status,vm.First_Name,vm.Last_Name, te.task_name as taskname,ia.name, ct.city_name, ia.verification_for, ia.qualification_name,ia.assigned_on, ia.status,ia.verification_user_id,ia.type as qualification_id, ia.location,ia.coordinator_id,ia.accept_on from insert_assigned_users as ia inner join cities as ct on ia.location=ct.city_id inner join user as us on us.User_Id=ia.assigned_to Inner join employment em on ia.type=em.empid inner join taskname te on te.task_name_id=em.task_name_id inner join verification_master vm on vm.Verification_Master_Id =ia.verification_user_id where ia.sstatus = 'Inprogress' and ia.state='$state' and ia.assigned_to='$user_id') union (select vm.Current_Address2,vm.Ref_no,ia.sstatus,ia.subco_status,vm.First_Name,vm.Last_Name, te.task_name as taskname,ia.name, ct.city_name, ia.verification_for, ia.qualification_name,ia.assigned_on, ia.status,ia.verification_user_id,ia.type as qualification_id, ia.location,ia.coordinator_id,ia.accept_on from insert_assigned_users as ia inner join cities as ct on ia.location=ct.city_id inner join user as us on us.User_Id=ia.assigned_to Inner join property_type pt on ia.type=pt.pro_id inner join taskname te on te.task_name_id=pt.task_name_id inner join verification_master vm on vm.Verification_Master_Id =ia.verification_user_id where ia.sstatus = 'Inprogress' and ia.state='$state' and ia.assigned_to='$user_id') union (select vm.Current_Address2,vm.Ref_no,ia.sstatus,ia.subco_status,vm.First_Name,vm.Last_Name, te.task_name as taskname,ia.name, ct.city_name, ia.verification_for, ia.qualification_name,ia.assigned_on, ia.status,ia.verification_user_id,ia.type as qualification_id, ia.location,ia.coordinator_id,ia.accept_on from insert_assigned_users as ia inner join cities as ct on ia.location=ct.city_id inner join user as us on us.User_Id=ia.assigned_to Inner join acc_mode am on ia.type=am.acc_id inner join taskname te on te.task_name_id=am.task_name_id inner join verification_master vm on vm.Verification_Master_Id =ia.verification_user_id where ia.sstatus = 'Inprogress' and ia.state='$state' and ia.assigned_to='$user_id') union (select vm.Current_Address2,vm.Ref_no,ia.sstatus,ia.subco_status,vm.First_Name,vm.Last_Name, te.task_name as taskname,ia.name, ct.city_name, ia.verification_for, ia.qualification_name,ia.assigned_on, ia.status,ia.verification_user_id,ia.type as qualification_id, ia.location,ia.coordinator_id,ia.accept_on from insert_assigned_users as ia inner join cities as ct on ia.location=ct.city_id inner join user as us on us.User_Id=ia.assigned_to Inner join address_group ag on ia.type=ag.add_grp_id inner join taskname te on te.task_name_id=ag.task_name_id inner join verification_master vm on vm.Verification_Master_Id =ia.verification_user_id where ia.sstatus = 'Inprogress' and ia.state='$state' and ia.assigned_to='$user_id')Order by assigned_on Desc" ;
...
$tvo_extra_comment = mysql_query("select * from tvo_extra_comment "); 
if(mysql_num_rows($tvo_extra_comment)== 0){
 	$tvo_extra_comment_array['data new veri'][] =  0;
	}
	else{
	 while($r7230912 = mysql_fetch_array($tvo_extra_comment)) {
	array_push($tvo_extra_comment_array,$r7230912);
}
}
...
array_push($collectionArray,$tvo_extra_comment_array); //43          //56
