...
$supervisor_final_command = mysql_query("select * from supervisor_final_command "); 
if(mysql_num_rows($supervisor_final_command)== 0){
 	$supervisor_final_command_array['data new veri'][] =  0;
	}
	else{
	 while($r7230912 = mysql_fetch_array($supervisor_final_command)) {
	array_push($supervisor_final_command_array,$r7230912);
}
}
...
array_push($collectionArray,$supervisor_final_command_array); //43          //57
