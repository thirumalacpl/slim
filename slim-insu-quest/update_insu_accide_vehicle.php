...
$ssqla = "UPDATE `vehicle_details` SET `reg_no`= '$vehicle_reg_no' , `reg_date`= '$vehicle_reg_date', `purchase_date`= '$vehicle_purchase_date', `type_of_vehicle`= '$vehicle_type_of_vehicle' , `purpose_of_vehicle`= '$vehicle_purpose_of_vehicle', `model`= '$vehicle_model', `color`= '$vehicle_color', `type_of_fuel`= '$vehicle_type_of_fuel' , `laden_weight`= '$vehicle_laden_weight' , `unladen_weight`= '$vehicle_unladen_weight' , `engine_no`= '$vehicle_engine_no', `chassis_no`= '$vehicle_chassis_no', `date_of_transfer`= '$vehicle_date_of_transfer' , `fc_details`= '$vehicle_fc_details', `hypothecation`= '$vehicle_hypothecation' ,`permit_details`= '$vehicle_permit_details',  `type_of_permit`= '$vehicle_type_of_permit' ,`permit_num`= '$vehicle_permit_num', `date_of_permit_expiry`= '$vehicle_date_of_permit_expiry', `date_of_permit_issue`= '$vehicle_date_of_permit_issue' ,`details_of_opp_vehicle`= '$vehicle_details_of_opp_vehicle' , `owner_of_opp_vehicle`= '$vehicle_owner_of_opp_vehicle' ,`km_run`= '$vehicle_km_run' where `user_id`= '$accident_details_a_user_id'";

$lssqla=mysql_query($ssqla);



$log = mysql_query("SELECT * FROM `vehicle_details` where `user_id`= '$accident_details_a_user_id'"); 
