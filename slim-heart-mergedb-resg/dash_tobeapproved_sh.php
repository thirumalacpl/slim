...
$state = $_REQUEST['state'];
 ...
 $user_rejectta=mysql_query("select count(*) as to_approved_sh, ia.ref_no,vm.Doc,ia.verified_on,ia.approved_on,ia.verified_on,vm.First_Name,vm.Last_Name,ia.sstatus, ia.task_name,ia.verification_user_id,ia.qualification_name,ia.name,ia.verification_user_id,ia.type,ia.sstatus,ia.verification_for,ia.state,vm.coordinator_status from insert_assigned_users as ia inner join verification_master as vm on vm.Verification_Master_Id=ia.verification_user_id where ia.state='$state' and ia.sstatus='Approved' and ia.rh_status!='done' and ia.sstatus!='rework' order by approved_on Desc");
	...
	array_push($to_approved_sh,$r30);



	 }

$lverification_veri="select ia.ref_no,vm.Doc,ia.verified_on,ia.approved_on,ia.verified_on,vm.First_Name,vm.Last_Name,ia.sstatus, ia.task_name,ia.verification_user_id,ia.qualification_name,ia.name,ia.verification_user_id,ia.type,ia.sstatus,ia.verification_for,ia.state,vm.coordinator_status from insert_assigned_users as ia inner join verification_master as vm on vm.Verification_Master_Id=ia.verification_user_id where ia.state='$state' and ia.sstatus='Approved' and ia.rh_status!='done' and ia.sstatus!='rework' order by approved_on Desc" ;
	...
	array_push($tobe_approved_sh,$r6);
...
array_push($collectionArray,$to_approved_sh);
array_push($collectionArray,$tobe_approved_sh);
