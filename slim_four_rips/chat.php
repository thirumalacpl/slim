...
/*	$ver_master = mysql_real_escape_string($_REQUEST['verification_user_id']);
	...
	$loginistant=mysql_real_escape_string($_REQUEST['loginistant']);

	
	$sstatus =mysql_real_escape_string( $_REQUEST['status_val_inpro']);
	$rremarkg =mysql_real_escape_string( $_REQUEST['remarkg']);*/
...
$ver_master = $_REQUEST['verification_user_id'];
	...
	$loginistant=$_REQUEST['loginistant'];
...
if($loginistant != '' &&  $loginistant !== 'sadkjgfnsfrjitf' ){
$rsql = "INSERT INTO `supervisor_activity_log`(`verification_id`,`type`,`activity_log`,`document`,`supervisor_id`,`log_date`,`status`)values('$ver_master','$qualification_id','$loginistant','','$user_id',now(),'supervisor')";
