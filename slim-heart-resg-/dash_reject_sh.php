...
$state = $_REQUEST['state'];
 ...
 $user_rejectta=mysql_query("select count(*) as reject_count from ((select vm.status,er.assigned_status as rej,vm.Doc,ta.task_name,vm.Verification_Master_Id,vm.Verification_For,vm.First_Name ,vm.Last_Name,vm.Current_Address1,vm.start_date,vm.Current_Address2,vm.Phone,vm.Mobile,vc.Verification_Category,qu.qualification_name as qname,er.education_type as edutype from verification_master as vm inner join insert_assigned_users ia on ia.verification_user_id=vm.Verification_Master_Id inner join educational_records as er on vm.Verification_Master_Id=er.user_id inner join qualifications as qu on er.education_type=qu.qualification_id Inner join taskname ta on ta.task_name_id=qu.task_name_id Inner join verification_category vc on vm.Verification_For=vc.Verification_Category_Id Inner join states st on st.id=er.state Inner join region rn on st.region_id=rn.region_id WHERE er.state = '$state' and er.assigned_status = 'reject' and er.reject_status != 'redo') union(select vm.status,evc.assigned_status as rej,vm.Doc,ta.task_name,vm.Verification_Master_Id,vm.Verification_For, vm.First_Name,vm.Last_Name,vm.Current_Address1,vm.start_date,vm.Current_Address2,vm.Phone, vm.Mobile, vc.Verification_Category, em.employment as qname,evc.employment_type as edutype from verification_master as vm inner join insert_assigned_users ia on ia.verification_user_id=vm.Verification_Master_Id Inner Join emp_verification_cumulative evc on vm.Verification_Master_Id=evc.user_id Inner Join employment em on em.empid=evc.employment_type Inner join taskname ta on ta.task_name_id=em.task_name_id Inner join verification_category vc on vm.Verification_For=vc.Verification_Category_Id Inner join states st on st.id=evc.employer_state_id Inner join region rn on st.region_id=rn.region_id where evc.employer_state_id = '$state' and evc.assigned_status = 'reject' and evc.reject_status != 'redo') union(select vm.status,aid.assigned_status as rej,vm.Doc, ta.task_name,vm.Verification_Master_Id,vm.Verification_For,vm.First_Name,vm.Last_Name,vm.Current_Address1,vm.start_date,vm.Current_Address2,vm.Phone, vm.Mobile, vc.Verification_Category, ad.address_name as qname,aid.proof_type_id as edutype from verification_master as vm inner join insert_assigned_users ia on ia.verification_user_id=vm.Verification_Master_Id inner join addressid_records as aid on vm.Verification_Master_Id=aid.user_id inner join address_type as ad on aid.proof_type_id=ad.id Inner join taskname ta on ta.task_name_id=ad.task_name_id Inner join verification_category vc on vm.Verification_For=vc.Verification_Category_Id Inner join states st on st.id=aid.state Inner join region rn on st.region_id=rn.region_id where aid.state = '$state' and aid.assigned_status='reject' and aid.reject_status !='redo') union(select vm.status,ast.assigned_status as rej,vm.Doc, ta.task_name,vm.Verification_Master_Id,vm.Verification_For,vm.First_Name,vm.Last_Name,vm.Current_Address1,vm.start_date,vm.Current_Address2,vm.Phone, vm.Mobile, vc.Verification_Category, pt.property_name as qname,ast.propert_type as edutype from verification_master as vm inner join insert_assigned_users ia on ia.verification_user_id=vm.Verification_Master_Id inner join assests_verification as ast on vm.Verification_Master_Id=ast.user_id inner join property_type as pt on ast.propert_type=pt.pro_id Inner join taskname ta on ta.task_name_id=pt.task_name_id Inner join verification_category vc on vm.Verification_For=vc.Verification_Category_Id Inner join states st on st.id=ast.state Inner join region rn on st.region_id=rn.region_id where ast.state = '$state' and ast.assigned_status='reject' and ast.reject_status !='redo') union(select vm.status,av.assigned_status as rej,vm.Doc, ta.task_name,vm.Verification_Master_Id,vm.Verification_For,vm.First_Name,vm.Last_Name,vm.Current_Address1,vm.start_date,vm.Current_Address2,vm.Phone, vm.Mobile, vc.Verification_Category, ag.add_name as qname,ag.add_grp_id as edutype from verification_master as vm inner join insert_assigned_users ia on ia.verification_user_id=vm.Verification_Master_Id inner join address_verification as av on vm.Verification_Master_Id=av.user_id inner join address_group as ag on av.address_group=ag.add_grp_id Inner join taskname ta on ta.task_name_id=ag.task_name_id Inner join verification_category vc on vm.Verification_For=vc.Verification_Category_Id Inner join states st on st.id=av.state Inner join region rn on st.region_id=rn.region_id where av.state = '$state' and av.assigned_status='reject' and av.reject_status !='redo') union(select vm.status,rf.assigned_status as rej,vm.Doc, ta.task_name,vm.Verification_Master_Id,vm.Verification_For,vm.First_Name,vm.Last_Name,vm.Current_Address1,vm.start_date,vm.Current_Address2,vm.Phone, vm.Mobile, vc.Verification_Category, ag.add_name as qname,ag.add_grp_id as edutype from verification_master as vm inner join insert_assigned_users ia on ia.verification_user_id=vm.Verification_Master_Id inner join reference_verification as rf on vm.Verification_Master_Id=rf.user_id inner join address_group as ag on rf.address_group=ag.add_grp_id Inner join taskname ta on ta.task_name_id=ag.task_name_id Inner join verification_category vc on vm.Verification_For=vc.Verification_Category_Id Inner join states st on st.id=rf.state Inner join region rn on st.region_id=rn.region_id where rf.state = '$state' and rf.assigned_status='reject' and rf.reject_status !='redo') union(select vm.status,dv.assigned_status as rej,vm.Doc, ta.task_name,vm.Verification_Master_Id,vm.Verification_For,vm.First_Name,vm.Last_Name,vm.Current_Address1,vm.start_date,vm.Current_Address2,vm.Phone, vm.Mobile, vc.Verification_Category, ag.add_name as qname,ag.add_grp_id as edutype from verification_master as vm inner join insert_assigned_users ia on ia.verification_user_id=vm.Verification_Master_Id inner join distributor_verification as dv on vm.Verification_Master_Id=dv.user_id inner join address_group as ag on dv.address_group=ag.add_grp_id Inner join taskname ta on ta.task_name_id=ag.task_name_id Inner join verification_category vc on vm.Verification_For=vc.Verification_Category_Id Inner join states st on st.id=dv.state Inner join region rn on st.region_id=rn.region_id where dv.state = '$state' and dv.assigned_status='reject' and dv.reject_status !='redo') union(select vm.status,dd.assigned_status as rej,vm.Doc, ta.task_name,vm.Verification_Master_Id,vm.Verification_For,vm.First_Name,vm.Last_Name,vm.Current_Address1,vm.start_date,vm.Current_Address2,vm.Phone, vm.Mobile, vc.Verification_Category, ag.add_name as qname,ag.add_grp_id as edutype from verification_master as vm inner join insert_assigned_users ia on ia.verification_user_id=vm.Verification_Master_Id inner join distributor_details as dd on vm.Verification_Master_Id=dd.user_id inner join address_group as ag on dd.address_group=ag.add_grp_id Inner join taskname ta on ta.task_name_id=ag.task_name_id Inner join verification_category vc on vm.Verification_For=vc.Verification_Category_Id Inner join states st on st.id=dd.state Inner join region rn on st.region_id=rn.region_id where dd.state = '$state' and dd.assigned_status='reject' and dd.reject_status !='redo') union(select vm.status,wb.assigned_status as rej,vm.Doc, ta.task_name,vm.Verification_Master_Id,vm.Verification_For,vm.First_Name,vm.Last_Name,vm.Current_Address1,vm.start_date,vm.Current_Address2,vm.Phone, vm.Mobile, vc.Verification_Category, ag.add_name as qname,ag.add_grp_id as edutype from verification_master as vm inner join insert_assigned_users ia on ia.verification_user_id=vm.Verification_Master_Id inner join web_verification as wb on vm.Verification_Master_Id=wb.user_id inner join address_group as ag on wb.address_group=ag.add_grp_id Inner join taskname ta on ta.task_name_id=ag.task_name_id Inner join verification_category vc on vm.Verification_For=vc.Verification_Category_Id Inner join states st on st.id=wb.state Inner join region rn on st.region_id=rn.region_id where wb.state = '$state' and wb.assigned_status='reject' and wb.reject_status !='redo') union(select vm.status,vm.assigned_status as rej,vm.Doc, ta.task_name,vm.Verification_Master_Id,vm.Verification_For,vm.First_Name,vm.Last_Name,vm.Current_Address1,vm.start_date,vm.Current_Address2,vm.Phone, vm.Mobile, vc.Verification_Category, ag.add_name as qname,ag.add_grp_id as edutype from verification_master as vm inner join insert_assigned_users ia on ia.verification_user_id=vm.Verification_Master_Id inner join address_group as ag on vm.address_group=ag.add_grp_id Inner join taskname ta on ta.task_name_id=ag.task_name_id Inner join verification_category vc on vm.Verification_For=vc.Verification_Category_Id Inner join states st on st.id=vm.Current_State Inner join region rn on st.region_id=rn.region_id where vm.current_state = '$state' and vm.assigned_status='reject' and vm.reject_status !='redo') union(select vm.status,sv.assigned_status as rej,vm.Doc, ta.task_name,vm.Verification_Master_Id,vm.Verification_For,vm.First_Name,vm.Last_Name,vm.Current_Address1,vm.start_date,vm.Current_Address2,vm.Phone, vm.Mobile, vc.Verification_Category, ag.add_name as qname,ag.add_grp_id as edutype from verification_master as vm inner join insert_assigned_users ia on ia.verification_user_id=vm.Verification_Master_Id inner join servant_verification as sv on vm.Verification_Master_Id=sv.user_id inner join address_group as ag on sv.address_group=ag.add_grp_id Inner join taskname ta on ta.task_name_id=ag.task_name_id Inner join verification_category vc on vm.Verification_For=vc.Verification_Category_Id Inner join states st on st.id=sv.state Inner join region rn on st.region_id=rn.region_id where sv.state = '$state' and sv.assigned_status='reject' and sv.reject_status !='redo') union(select vm.status,wh.assigned_status as rej,vm.Doc, ta.task_name,vm.Verification_Master_Id,vm.Verification_For,vm.First_Name,vm.Last_Name,vm.Current_Address1,vm.start_date,vm.Current_Address2,vm.Phone, vm.Mobile, vc.Verification_Category, ag.add_name as qname,ag.add_grp_id as edutype from verification_master as vm inner join insert_assigned_users ia on ia.verification_user_id=vm.Verification_Master_Id inner join warehouse_verification as wh on vm.Verification_Master_Id=wh.user_id inner join address_group as ag on wh.address_group=ag.add_grp_id Inner join taskname ta on ta.task_name_id=ag.task_name_id Inner join verification_category vc on vm.Verification_For=vc.Verification_Category_Id Inner join states st on st.id=wh.state Inner join region rn on st.region_id=rn.region_id where wh.state = '$state' and wh.assigned_status='reject' and wh.reject_status !='redo') union(select vm.status,dvd.assigned_status as rej,vm.Doc, ta.task_name,vm.Verification_Master_Id,vm.Verification_For,vm.First_Name,vm.Last_Name,vm.Current_Address1,vm.start_date,vm.Current_Address2,vm.Phone, vm.Mobile, vc.Verification_Category, ag.add_name as qname,ag.add_grp_id as edutype from verification_master as vm inner join insert_assigned_users ia on ia.verification_user_id=vm.Verification_Master_Id inner join driving_details as dvd on vm.Verification_Master_Id=dvd.user_id inner join address_group as ag on dvd.address_group=ag.add_grp_id Inner join taskname ta on ta.task_name_id=ag.task_name_id Inner join verification_category vc on vm.Verification_For=vc.Verification_Category_Id Inner join states st on st.id=dvd.state Inner join region rn on st.region_id=rn.region_id where dvd.state = '$state' and dvd.assigned_status='reject' and dvd.reject_status !='redo') union(select vm.status,bgv.assigned_status as rej,vm.Doc, ta.task_name,vm.Verification_Master_Id,vm.Verification_For,vm.First_Name,vm.Last_Name,vm.Current_Address1,vm.start_date,vm.Current_Address2,vm.Phone, vm.Mobile, vc.Verification_Category, ag.add_name as qname,ag.add_grp_id as edutype from verification_master as vm inner join insert_assigned_users ia on ia.verification_user_id=vm.Verification_Master_Id inner join bankguarantee_verification as bgv on vm.Verification_Master_Id=bgv.user_id inner join address_group as ag on bgv.address_group=ag.add_grp_id Inner join taskname ta on ta.task_name_id=ag.task_name_id Inner join verification_category vc on vm.Verification_For=vc.Verification_Category_Id Inner join states st on st.id=bgv.state Inner join region rn on st.region_id=rn.region_id where bgv.state = '$state' and bgv.assigned_status='reject' and bgv.reject_status !='redo') union(select vm.status,brv.assigned_status as rej,vm.Doc, ta.task_name,vm.Verification_Master_Id,vm.Verification_For,vm.First_Name,vm.Last_Name,vm.Current_Address1,vm.start_date,vm.Current_Address2,vm.Phone, vm.Mobile, vc.Verification_Category, ag.add_name as qname,ag.add_grp_id as edutype from verification_master as vm inner join insert_assigned_users ia on ia.verification_user_id=vm.Verification_Master_Id inner join bankruptcy_verification as brv on vm.Verification_Master_Id=brv.user_id inner join address_group as ag on brv.address_group=ag.add_grp_id Inner join taskname ta on ta.task_name_id=ag.task_name_id Inner join verification_category vc on vm.Verification_For=vc.Verification_Category_Id Inner join states st on st.id=brv.state Inner join region rn on st.region_id=rn.region_id where brv.state = '$state' and brv.assigned_status='reject' and brv.reject_status !='redo') union(select vm.status,pd.assigned_status as rej,vm.Doc, ta.task_name,vm.Verification_Master_Id,vm.Verification_For,vm.First_Name,vm.Last_Name,vm.Current_Address1,vm.start_date,vm.Current_Address2,vm.Phone, vm.Mobile, vc.Verification_Category, ag.add_name as qname,ag.add_grp_id as edutype from verification_master as vm inner join insert_assigned_users ia on ia.verification_user_id=vm.Verification_Master_Id inner join professional_details as pd on vm.Verification_Master_Id=pd.user_id inner join address_group as ag on pd.address_group=ag.add_grp_id Inner join taskname ta on ta.task_name_id=ag.task_name_id Inner join verification_category vc on vm.Verification_For=vc.Verification_Category_Id Inner join states st on st.id=pd.state Inner join region rn on st.region_id=rn.region_id where pd.state = '$state' and pd.assigned_status='reject' and pd.reject_status !='redo')) as dfr");
	
	 

	 while($r30 = mysql_fetch_array($user_rejectta)) {

	// 	$view_assigned_user_download_array['data3'][] = $r3;
	array_push($sh_reject_list_count,$r30);
 ...
 $user_rejecr=mysql_query("(select vm.status,er.assigned_status as rej,vm.Doc,ta.task_name,vm.Verification_Master_Id,vm.Verification_For,vm.First_Name ,vm.Last_Name,vm.Current_Address1,vm.start_date,vm.Current_Address2,vm.Phone,vm.Mobile,vc.Verification_Category,qu.qualification_name as qname,er.education_type as edutype from verification_master as vm inner join insert_assigned_users ia on ia.verification_user_id=vm.Verification_Master_Id inner join educational_records as er on vm.Verification_Master_Id=er.user_id inner join qualifications as qu on er.education_type=qu.qualification_id Inner join taskname ta on ta.task_name_id=qu.task_name_id Inner join verification_category vc on vm.Verification_For=vc.Verification_Category_Id Inner join states st on st.id=er.state Inner join region rn on st.region_id=rn.region_id WHERE er.state = '$state' and er.assigned_status = 'reject' and er.reject_status != 'redo') union(select vm.status,evc.assigned_status as rej,vm.Doc,ta.task_name,vm.Verification_Master_Id,vm.Verification_For, vm.First_Name,vm.Last_Name,vm.Current_Address1,vm.start_date,vm.Current_Address2,vm.Phone, vm.Mobile, vc.Verification_Category, em.employment as qname,evc.employment_type as edutype from verification_master as vm inner join insert_assigned_users ia on ia.verification_user_id=vm.Verification_Master_Id Inner Join emp_verification_cumulative evc on vm.Verification_Master_Id=evc.user_id Inner Join employment em on em.empid=evc.employment_type Inner join taskname ta on ta.task_name_id=em.task_name_id Inner join verification_category vc on vm.Verification_For=vc.Verification_Category_Id Inner join states st on st.id=evc.employer_state_id Inner join region rn on st.region_id=rn.region_id where evc.employer_state_id = '$state' and evc.assigned_status = 'reject' and evc.reject_status != 'redo') union(select vm.status,aid.assigned_status as rej,vm.Doc, ta.task_name,vm.Verification_Master_Id,vm.Verification_For,vm.First_Name,vm.Last_Name,vm.Current_Address1,vm.start_date,vm.Current_Address2,vm.Phone, vm.Mobile, vc.Verification_Category, ad.address_name as qname,aid.proof_type_id as edutype from verification_master as vm inner join insert_assigned_users ia on ia.verification_user_id=vm.Verification_Master_Id inner join addressid_records as aid on vm.Verification_Master_Id=aid.user_id inner join address_type as ad on aid.proof_type_id=ad.id Inner join taskname ta on ta.task_name_id=ad.task_name_id Inner join verification_category vc on vm.Verification_For=vc.Verification_Category_Id Inner join states st on st.id=aid.state Inner join region rn on st.region_id=rn.region_id where aid.state = '$state' and aid.assigned_status='reject' and aid.reject_status !='redo') union(select vm.status,ast.assigned_status as rej,vm.Doc, ta.task_name,vm.Verification_Master_Id,vm.Verification_For,vm.First_Name,vm.Last_Name,vm.Current_Address1,vm.start_date,vm.Current_Address2,vm.Phone, vm.Mobile, vc.Verification_Category, pt.property_name as qname,ast.propert_type as edutype from verification_master as vm inner join insert_assigned_users ia on ia.verification_user_id=vm.Verification_Master_Id inner join assests_verification as ast on vm.Verification_Master_Id=ast.user_id inner join property_type as pt on ast.propert_type=pt.pro_id Inner join taskname ta on ta.task_name_id=pt.task_name_id Inner join verification_category vc on vm.Verification_For=vc.Verification_Category_Id Inner join states st on st.id=ast.state Inner join region rn on st.region_id=rn.region_id where ast.state = '$state' and ast.assigned_status='reject' and ast.reject_status !='redo') union(select vm.status,av.assigned_status as rej,vm.Doc, ta.task_name,vm.Verification_Master_Id,vm.Verification_For,vm.First_Name,vm.Last_Name,vm.Current_Address1,vm.start_date,vm.Current_Address2,vm.Phone, vm.Mobile, vc.Verification_Category, ag.add_name as qname,ag.add_grp_id as edutype from verification_master as vm inner join insert_assigned_users ia on ia.verification_user_id=vm.Verification_Master_Id inner join address_verification as av on vm.Verification_Master_Id=av.user_id inner join address_group as ag on av.address_group=ag.add_grp_id Inner join taskname ta on ta.task_name_id=ag.task_name_id Inner join verification_category vc on vm.Verification_For=vc.Verification_Category_Id Inner join states st on st.id=av.state Inner join region rn on st.region_id=rn.region_id where av.state = '$state' and av.assigned_status='reject' and av.reject_status !='redo') union(select vm.status,rf.assigned_status as rej,vm.Doc, ta.task_name,vm.Verification_Master_Id,vm.Verification_For,vm.First_Name,vm.Last_Name,vm.Current_Address1,vm.start_date,vm.Current_Address2,vm.Phone, vm.Mobile, vc.Verification_Category, ag.add_name as qname,ag.add_grp_id as edutype from verification_master as vm inner join insert_assigned_users ia on ia.verification_user_id=vm.Verification_Master_Id inner join reference_verification as rf on vm.Verification_Master_Id=rf.user_id inner join address_group as ag on rf.address_group=ag.add_grp_id Inner join taskname ta on ta.task_name_id=ag.task_name_id Inner join verification_category vc on vm.Verification_For=vc.Verification_Category_Id Inner join states st on st.id=rf.state Inner join region rn on st.region_id=rn.region_id where rf.state = '$state' and rf.assigned_status='reject' and rf.reject_status !='redo') union(select vm.status,dv.assigned_status as rej,vm.Doc, ta.task_name,vm.Verification_Master_Id,vm.Verification_For,vm.First_Name,vm.Last_Name,vm.Current_Address1,vm.start_date,vm.Current_Address2,vm.Phone, vm.Mobile, vc.Verification_Category, ag.add_name as qname,ag.add_grp_id as edutype from verification_master as vm inner join insert_assigned_users ia on ia.verification_user_id=vm.Verification_Master_Id inner join distributor_verification as dv on vm.Verification_Master_Id=dv.user_id inner join address_group as ag on dv.address_group=ag.add_grp_id Inner join taskname ta on ta.task_name_id=ag.task_name_id Inner join verification_category vc on vm.Verification_For=vc.Verification_Category_Id Inner join states st on st.id=dv.state Inner join region rn on st.region_id=rn.region_id where dv.state = '$state' and dv.assigned_status='reject' and dv.reject_status !='redo') union(select vm.status,dd.assigned_status as rej,vm.Doc, ta.task_name,vm.Verification_Master_Id,vm.Verification_For,vm.First_Name,vm.Last_Name,vm.Current_Address1,vm.start_date,vm.Current_Address2,vm.Phone, vm.Mobile, vc.Verification_Category, ag.add_name as qname,ag.add_grp_id as edutype from verification_master as vm inner join insert_assigned_users ia on ia.verification_user_id=vm.Verification_Master_Id inner join distributor_details as dd on vm.Verification_Master_Id=dd.user_id inner join address_group as ag on dd.address_group=ag.add_grp_id Inner join taskname ta on ta.task_name_id=ag.task_name_id Inner join verification_category vc on vm.Verification_For=vc.Verification_Category_Id Inner join states st on st.id=dd.state Inner join region rn on st.region_id=rn.region_id where dd.state = '$state' and dd.assigned_status='reject' and dd.reject_status !='redo') union(select vm.status,wb.assigned_status as rej,vm.Doc, ta.task_name,vm.Verification_Master_Id,vm.Verification_For,vm.First_Name,vm.Last_Name,vm.Current_Address1,vm.start_date,vm.Current_Address2,vm.Phone, vm.Mobile, vc.Verification_Category, ag.add_name as qname,ag.add_grp_id as edutype from verification_master as vm inner join insert_assigned_users ia on ia.verification_user_id=vm.Verification_Master_Id inner join web_verification as wb on vm.Verification_Master_Id=wb.user_id inner join address_group as ag on wb.address_group=ag.add_grp_id Inner join taskname ta on ta.task_name_id=ag.task_name_id Inner join verification_category vc on vm.Verification_For=vc.Verification_Category_Id Inner join states st on st.id=wb.state Inner join region rn on st.region_id=rn.region_id where wb.state = '$state' and wb.assigned_status='reject' and wb.reject_status !='redo') union(select vm.status,vm.assigned_status as rej,vm.Doc, ta.task_name,vm.Verification_Master_Id,vm.Verification_For,vm.First_Name,vm.Last_Name,vm.Current_Address1,vm.start_date,vm.Current_Address2,vm.Phone, vm.Mobile, vc.Verification_Category, ag.add_name as qname,ag.add_grp_id as edutype from verification_master as vm inner join insert_assigned_users ia on ia.verification_user_id=vm.Verification_Master_Id inner join address_group as ag on vm.address_group=ag.add_grp_id Inner join taskname ta on ta.task_name_id=ag.task_name_id Inner join verification_category vc on vm.Verification_For=vc.Verification_Category_Id Inner join states st on st.id=vm.Current_State Inner join region rn on st.region_id=rn.region_id where vm.current_state = '$state' and vm.assigned_status='reject' and vm.reject_status !='redo') union(select vm.status,sv.assigned_status as rej,vm.Doc, ta.task_name,vm.Verification_Master_Id,vm.Verification_For,vm.First_Name,vm.Last_Name,vm.Current_Address1,vm.start_date,vm.Current_Address2,vm.Phone, vm.Mobile, vc.Verification_Category, ag.add_name as qname,ag.add_grp_id as edutype from verification_master as vm inner join insert_assigned_users ia on ia.verification_user_id=vm.Verification_Master_Id inner join servant_verification as sv on vm.Verification_Master_Id=sv.user_id inner join address_group as ag on sv.address_group=ag.add_grp_id Inner join taskname ta on ta.task_name_id=ag.task_name_id Inner join verification_category vc on vm.Verification_For=vc.Verification_Category_Id Inner join states st on st.id=sv.state Inner join region rn on st.region_id=rn.region_id where sv.state = '$state' and sv.assigned_status='reject' and sv.reject_status !='redo') union(select vm.status,wh.assigned_status as rej,vm.Doc, ta.task_name,vm.Verification_Master_Id,vm.Verification_For,vm.First_Name,vm.Last_Name,vm.Current_Address1,vm.start_date,vm.Current_Address2,vm.Phone, vm.Mobile, vc.Verification_Category, ag.add_name as qname,ag.add_grp_id as edutype from verification_master as vm inner join insert_assigned_users ia on ia.verification_user_id=vm.Verification_Master_Id inner join warehouse_verification as wh on vm.Verification_Master_Id=wh.user_id inner join address_group as ag on wh.address_group=ag.add_grp_id Inner join taskname ta on ta.task_name_id=ag.task_name_id Inner join verification_category vc on vm.Verification_For=vc.Verification_Category_Id Inner join states st on st.id=wh.state Inner join region rn on st.region_id=rn.region_id where wh.state = '$state' and wh.assigned_status='reject' and wh.reject_status !='redo') union(select vm.status,dvd.assigned_status as rej,vm.Doc, ta.task_name,vm.Verification_Master_Id,vm.Verification_For,vm.First_Name,vm.Last_Name,vm.Current_Address1,vm.start_date,vm.Current_Address2,vm.Phone, vm.Mobile, vc.Verification_Category, ag.add_name as qname,ag.add_grp_id as edutype from verification_master as vm inner join insert_assigned_users ia on ia.verification_user_id=vm.Verification_Master_Id inner join driving_details as dvd on vm.Verification_Master_Id=dvd.user_id inner join address_group as ag on dvd.address_group=ag.add_grp_id Inner join taskname ta on ta.task_name_id=ag.task_name_id Inner join verification_category vc on vm.Verification_For=vc.Verification_Category_Id Inner join states st on st.id=dvd.state Inner join region rn on st.region_id=rn.region_id where dvd.state = '$state' and dvd.assigned_status='reject' and dvd.reject_status !='redo') union(select vm.status,bgv.assigned_status as rej,vm.Doc, ta.task_name,vm.Verification_Master_Id,vm.Verification_For,vm.First_Name,vm.Last_Name,vm.Current_Address1,vm.start_date,vm.Current_Address2,vm.Phone, vm.Mobile, vc.Verification_Category, ag.add_name as qname,ag.add_grp_id as edutype from verification_master as vm inner join insert_assigned_users ia on ia.verification_user_id=vm.Verification_Master_Id inner join bankguarantee_verification as bgv on vm.Verification_Master_Id=bgv.user_id inner join address_group as ag on bgv.address_group=ag.add_grp_id Inner join taskname ta on ta.task_name_id=ag.task_name_id Inner join verification_category vc on vm.Verification_For=vc.Verification_Category_Id Inner join states st on st.id=bgv.state Inner join region rn on st.region_id=rn.region_id where bgv.state = '$state' and bgv.assigned_status='reject' and bgv.reject_status !='redo') union(select vm.status,brv.assigned_status as rej,vm.Doc, ta.task_name,vm.Verification_Master_Id,vm.Verification_For,vm.First_Name,vm.Last_Name,vm.Current_Address1,vm.start_date,vm.Current_Address2,vm.Phone, vm.Mobile, vc.Verification_Category, ag.add_name as qname,ag.add_grp_id as edutype from verification_master as vm inner join insert_assigned_users ia on ia.verification_user_id=vm.Verification_Master_Id inner join bankruptcy_verification as brv on vm.Verification_Master_Id=brv.user_id inner join address_group as ag on brv.address_group=ag.add_grp_id Inner join taskname ta on ta.task_name_id=ag.task_name_id Inner join verification_category vc on vm.Verification_For=vc.Verification_Category_Id Inner join states st on st.id=brv.state Inner join region rn on st.region_id=rn.region_id where brv.state = '$state' and brv.assigned_status='reject' and brv.reject_status !='redo') union(select vm.status,pd.assigned_status as rej,vm.Doc, ta.task_name,vm.Verification_Master_Id,vm.Verification_For,vm.First_Name,vm.Last_Name,vm.Current_Address1,vm.start_date,vm.Current_Address2,vm.Phone, vm.Mobile, vc.Verification_Category, ag.add_name as qname,ag.add_grp_id as edutype from verification_master as vm inner join insert_assigned_users ia on ia.verification_user_id=vm.Verification_Master_Id inner join professional_details as pd on vm.Verification_Master_Id=pd.user_id inner join address_group as ag on pd.address_group=ag.add_grp_id Inner join taskname ta on ta.task_name_id=ag.task_name_id Inner join verification_category vc on vm.Verification_For=vc.Verification_Category_Id Inner join states st on st.id=pd.state Inner join region rn on st.region_id=rn.region_id where pd.state = '$state' and pd.assigned_status='reject' and pd.reject_status !='redo')");
	
	 

	 while($r28 = mysql_fetch_array($user_rejecr)) {

	// 	$view_assigned_user_download_array['data3'][] = $r3;
	array_push($sh_reject_list,$r28);
...
$supervisor_viewa=mysql_query($lverification);
	...
	while($r21 = mysql_fetch_array($supervisor_viewa)) {

		array_push($insertassign_employment_array,$r21);
...
array_push($collectionArray,$sh_reject_list_count);
array_push($collectionArray,$sh_reject_list);
