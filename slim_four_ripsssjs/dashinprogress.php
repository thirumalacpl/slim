...
if(mysql_num_rows($activity_log_details)== 0){
	...
	array_push($activity_log_supervisor_details_array,$r3);
...
if(mysql_num_rows($multiple_super)== 0){
	 ...
	 while($r5 = mysql_fetch_array($multiple_super)) {


	array_push($image_log_array,$r5);
...
if(mysql_num_rows($coordinator_final_comment)== 0){
	 ...
	 while($r64678 = mysql_fetch_array($coordinator_final_comment)) {


	array_push($coordinator_final_comment_array,$r64678);
...
array_push($collectionArray,$activity_log_supervisor_details_array);
array_push($collectionArray,$image_log_array);
...
array_push($collectionArray,$sh_eeem_array);
array_push($collectionArray,$multiple_documents_array);
array_push($collectionArray,$tet_array);
