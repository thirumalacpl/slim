...
$insertchest = mysql_query("INSERT into patient_obser_details (`patient_obs_id`,`observation_id`,`category_id`,`created_date`) values ('$patient_id','$chstpain','1',now())");
...
$inssituation = mysql_query("INSERT into patient_obser_details (`patient_obs_id`,`observation_id`,`category_id`,`created_date`) values ('$patient_id','$painstrtt3','3',now())");

$insspray = mysql_query("INSERT into patient_obser_details (`patient_obs_id`,`observation_id`,`category_id`,`created_date`) values ('$patient_id','$painstrtt4','4',now())");

$insbreathing = mysql_query("INSERT into patient_obser_details (`patient_obs_id`,`observation_id`,`category_id`,`created_date`) values ('$patient_id','$painstrtt5','5',now())");

$inschestpain = mysql_query("INSERT into patient_obser_details (`patient_obs_id`,`observation_id`,`category_id`,`created_date`) values ('$patient_id','$painstrtt6','6',now())");

$inspalpit = mysql_query("INSERT into patient_obser_details (`patient_obs_id`,`observation_id`,`category_id`,`created_date`) values ('$patient_id','$painstrtt7','7',now())");

$insvomit = mysql_query("INSERT into patient_obser_details (`patient_obs_id`,`observation_id`,`category_id`,`created_date`) values ('$patient_id','$painstrtt8','8',now())");

$inssweating = mysql_query("INSERT into patient_obser_details (`patient_obs_id`,`observation_id`,`category_id`,`created_date`) values ('$patient_id','$painstrtt9','9',now())");

$insfear = mysql_query("INSERT into patient_obser_details (`patient_obs_id`,`observation_id`,`category_id`,`created_date`) values ('$patient_id','$painstrtt10','10',now())");
